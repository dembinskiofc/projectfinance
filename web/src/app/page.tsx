...
const categories = [
  { id: "1", icon: Hamburger, name: "Alimentação", quantity: 10, amount: 1508 },
  { id: "2", icon: Car, name: "Transporte", quantity: 5, amount: 200 },
  { id: "3", icon: TreePalm, name: "Lazer", quantity: 3, amount: 200 },
  { id: "4", icon: Pill, name: "Saúde", quantity: 2, amount: 500 },
  { id: "5", icon: CircleEllipsis, name: "Educação", quantity: 1, amount: 100 },
];
